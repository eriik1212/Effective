...
Enemy_White::Enemy_White(int x, int y) : Enemy(x, y)
{
	...
	upAnimRW.loop = true;
	upAnimRW.speed = 0.25f;

	
	path.PushBack({ -0.8f, 0.0f }, 150, &leftAnimW);
	path.PushBack({ 0.8f,0.0f }, 150, &rightAnimW);
